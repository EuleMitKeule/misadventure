...
public class PlayerComponent : MonoBehaviour
{
    ...
    /// </summary>
    bool IsInDeadzone => LookDistance < WeaponComponent.deadzoneRadius;
    /// <summary>
    /// The position of the look target projected onto the deadzone circle.
    /// </summary>
    Vector2 DeadzonedMousePosition => Rigidbody.position + LookDirection * WeaponComponent.deadzoneRadius;
    /// <summary>
